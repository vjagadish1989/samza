...
/**
 * Specifies a time interval for applying a window transform over a {@code MessageStream}. Users should
...
public final class Time {
  ...
  /**
   * Creates a new {@link Time} that specifies the provided time unit.
